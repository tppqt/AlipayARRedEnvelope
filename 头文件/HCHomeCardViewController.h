...
#import "CSPublishFeedDelegate.h"
...
@class BEESmilePullRefreshView, CSPublishFeed, DTRpcAsyncCaller, HCCardEmptyView, HCCardLoadingView, HCDeleteEmptyView, HCHeadView, HCHomeCardDataManager, HCHomeCardMonitor, HCHomeScrollLog, HCLoadErroView, HCPopMenuRouteManager, NSDate, NSString;

@interface HCHomeCardViewController : CCardBaseViewController <BEEMultiStyleCellDelegate, BEESmilePullRefreshViewDelegate, SocialRemindHeadViewDelegate, CCardResendRemindViewDelegate, HCPopMenuRouteManagerDelegate, CSendNewsfeedViewDelegaete, CSPublishFeedDelegate, HCHCLoadErroViewDelegate, HCHeadViewDelegate>
{
    _Bool _viewInAppear;
    _Bool _dataDirty;
    ...
    HCHomeCardMonitor *_homeCardMonitor;
}
...
@property(retain, nonatomic) HCHomeCardMonitor *homeCardMonitor; // @synthesize homeCardMonitor=_homeCardMonitor;
...
- (void)sendNewsfeed;
- (void)showPublicActionSheet;
- (void)musicPlayStateChanged:(id)arg1;
...
- (void)updateUnread;
- (void)updateTabBarWithOptionCount:(unsigned long long)arg1 newCardCount:(unsigned long long)arg2;
