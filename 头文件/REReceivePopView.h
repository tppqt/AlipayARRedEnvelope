...
@class GIFTPRODGiftCrowdDetailResult, REBlockButton, REButton, RECoinButton, REReceiverAvatarView, UIImage, UIImageView, UILabel, UITapGestureRecognizer, UIView;
