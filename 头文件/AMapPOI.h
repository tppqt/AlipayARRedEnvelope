...
@class AMapGeoPoint, AMapIndoorData, AMapPOIExtension, NSArray, NSDictionary, NSString;
...
- (id)init;
@property(nonatomic) _Bool municipality;
@property(retain, nonatomic) NSString *alipayCountry;
@property(retain, nonatomic) NSDictionary *logInfoDict; // @dynamic logInfoDict;
@property(nonatomic) _Bool BEELocalLocationIsOverseas;
- (id)detailUrl;
- (id)detailOverseasUrl;
- (id)detailPoiUrl;
- (id)detailShopUrl;
