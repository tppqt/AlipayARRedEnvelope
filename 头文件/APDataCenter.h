...
@class APCustomStorage, APDAOProxyRouter, APSharedPreferences<APSharedPreferencesRunMode>, NSMutableDictionary, NSObject<OS_dispatch_semaphore>, NSString, NSTimer;
...
@interface APDataCenter : NSObject <APDAOProxyRouterDelegate>
{
    ...
    NSMutableDictionary *_daoConfigurations;
    NSMutableDictionary *_daoContainerPreferences;
    APDAOProxyRouter *_userProxy;
    NSObject<OS_dispatch_semaphore> *_daoLock;
