...
@interface AggregationQueryResponse : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    NSMutableArray *_arModelInfos;
}

+ (id)parseFromData:(id)arg1;
@property(retain, nonatomic) NSMutableArray *arModelInfos; // @synthesize arModelInfos=_arModelInfos;
...
- (void)addArModelInfos:(id)arg1;
- (void)setArModelInfosArray:(id)arg1;
- (int)serializedSize;
