...
@interface O2OHotShopQueryResponse : APPBGeneratedMessage <GeneratedMessageProtocol>
{
...
- (void)addCategoryList:(id)arg1;
- (void)setCategoryListArray:(id)arg1;
- (void)addAdList:(id)arg1;
- (void)setAdListArray:(id)arg1;
- (int)serializedSize;
