...
@class ANXOfflinePayRootController, NSString;

@interface ANXOfflinePayAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    ANXOfflinePayRootController *_rootController;
}

@property(retain, nonatomic) ANXOfflinePayRootController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
