...
@class APExceptionView, APGLocalSearchEngineResult, APGSearchDetailViewController, APGSearchErrorView, APGSearchManager, APGSearchResultViewController, APGTabConfig, NSMutableArray, NSOperationQueue, NSString, WKTableCellModel, WKTableViewController;
...
@property(nonatomic) _Bool hasLocalAppResult; // @synthesize hasLocalAppResult=_hasLocalAppResult;
...
- (void)onSearchText:(id)arg1 result:(id)arg2 resultFromServer:(_Bool)arg3 bucketId:(id)arg4 error:(id)arg5;
