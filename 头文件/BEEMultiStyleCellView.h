...
#import "BEEButtonDelegate.h"

@class NSArray, NSString;

@interface BEEMultiStyleCellView : UIView <BEEButtonDelegate>
{
    id <BEEMultiStyleCellDelegate> _delegate;
    NSArray *_cellDataArray;
}

@property(retain, nonatomic) NSArray *cellDataArray; // @synthesize cellDataArray=_cellDataArray;
@property(nonatomic) __weak id <BEEMultiStyleCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
