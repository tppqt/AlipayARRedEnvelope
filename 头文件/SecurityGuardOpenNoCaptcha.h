...
+ (id)doJAQForwardAuthWithParam:(id)arg1 methodName:(id)arg2 timeout:(long long)arg3 hostenv:(long long)arg4 error:(int *)arg5;
...
- (void).cxx_destruct;
- (id)noCaptchaForwardAuth:(id)arg1 authInfo:(id)arg2 timeout:(long long)arg3;
- (Class)getMetaClass;
