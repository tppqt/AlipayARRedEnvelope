...
@class ASAuthorized, ASPhotoEditorController, NSString, UIImagePickerController, UINavigationController;

@interface ASImagePickerController : NSObject <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
{
    ...
    ASAuthorized *_authorized;
}

@property(retain, nonatomic) ASAuthorized *authorized; // @synthesize authorized=_authorized;
