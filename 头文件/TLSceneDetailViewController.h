...
@class APAlertView, AUActionSheet, NSString, TLBarCameraButton, TLFeed, TLInputTextMaxControl, TLPlumpScene, TLSceneAdController, TLSceneDetailController, TLSceneOperationBar, TLSceneTitleView, TLSceneView, UIView;

@interface TLSceneDetailViewController : TLCommentBaseViewController <TLSceneOperationBarDelegate, TLSceneDetailControllerDelegate, UIAlertViewDelegate, TLSceneViewDelegate, UIActionSheetDelegate>
{
...
@property(retain, nonatomic) APAlertView *sceneAlertView; // @synthesize sceneAlertView=_sceneAlertView;
