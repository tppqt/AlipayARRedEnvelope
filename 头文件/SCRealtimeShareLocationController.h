...
@class APAlertView, APMapLocation, APMapShareLocationView, NSDate, NSMutableArray, NSMutableDictionary, NSString, UIButton, UILabel, UIScrollView, UIView, UIViewController;
...
@interface SCRealtimeShareLocationController : SCCommonBaseViewController <UIActionSheetDelegate>
{
    ...
    APAlertView *_networkErrAlertView;
}

@property(nonatomic) __weak APAlertView *networkErrAlertView; // @synthesize networkErrAlertView=_networkErrAlertView;
