...
@class APActionSheetManager, NSDictionary, NSMutableArray, NSNumber, NSString, UIButton, UIColor, UITableView, UIWindow;

@interface APActionSheet : UIView <UITableViewDataSource, UITableViewDelegate, UIAppearanceContainer>
{
    APActionSheetManager *_actionManager;
    _Bool animating;
    _Bool closeSelf;
...
@property(nonatomic) __weak id <UIActionSheetDelegate> dtDelegate; // @synthesize dtDelegate=_dtDelegate;
