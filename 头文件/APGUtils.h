...
+ (id)getLocalAppInfos:(id)arg1;
+ (id)addAppServerInfos:(id)arg1 appInfos:(id)arg2;
+ (id)cellDataFromRemoteGroupRecord:(id)arg1 bucketId:(id)arg2 localCellData:(id)arg3;
+ (id)cellDataFromRemoteGroupRecord:(id)arg1 bucketId:(id)arg2;
+ (id)cellDataFromLocalGroupRecord:(id)arg1;
+ (id)trim:(id)arg1;
