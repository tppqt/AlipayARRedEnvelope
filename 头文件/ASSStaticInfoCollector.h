...
@property(retain, nonatomic) NSString *bootTime; // @synthesize bootTime=_bootTime;
...
- (void).cxx_destruct;
- (_Bool)getAdjustBootTimeResult;
- (id)getPublicIPInfo;
- (id)getFingerHashInfo;
- (id)getAppInstalledTime:(id)arg1;
- (id)getContactInfo;
- (id)getOtherAppToken;
- (id)getWifiMac;
- (_Bool)checkOtherToken;
- (_Bool)checkProfile;
- (_Bool)checkImage;
- (_Bool)checkContact;
...
- (void)updateIncrementInfo;
- (void)updateBootTime;
- (void)updateIC4:(id)arg1;
- (void)updateUserID:(id)arg1;
- (void)updateMaiDianInfo:(id)arg1;
