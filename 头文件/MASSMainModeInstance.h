...
@class MASSTokenTask, NSMutableArray, NSMutableDictionary, NSString, NSThread;
...
- (void)startARUPTask;
- (void)sendTfsDownloadTaskToMassFrom:(id)arg1 Url:(id)arg2 resultForm:(long long)arg3 filePath:(id)arg4 bizType:(id)arg5 taskKey:(id)arg6 extralHeaders:(id)arg7;
...
- (void)sendDownloadTaskToMASS:(id)arg1 fileName:(id)arg2 fileID:(id)arg3 filePath:(id)arg4 resultForm:(long long)arg5 isPic:(_Bool)arg6 zoom:(id)arg7 needCrypto:(_Bool)arg8 needGradual:(_Bool)arg9 bizType:(id)arg10 taskKey:(id)arg11;
- (void)sendUploadTaskToMASS:(id)arg1 content:(id)arg2 fileName:(id)arg3 needJudgeQic:(_Bool)arg4 needCrypto:(_Bool)arg5 bizType:(id)arg6 routerDir:(long long)arg7 taskKey:(id)arg8;
