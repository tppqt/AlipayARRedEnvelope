...
@class DTViewController, H5WebViewController, MBProgressHUD, NSDate, NSDictionary, NSString, PPChatCacheDelegate, PPChatDataController, PPChatMessage, PPChatPublicAccount, PPChatSetting, PPChatThirdPartyAccount, PPReportAbuseViewController, UIViewController;
...
@interface PPChatContext : NSObject <H5ServiceDelegate, PPChatThirdPartyAccountDataDelegate>
{
    ...
    PPReportAbuseViewController *_abuseCtroller;
...
@property(nonatomic) __weak PPReportAbuseViewController *abuseCtroller; // @synthesize abuseCtroller=_abuseCtroller;
...
- (CDUnknownBlockType)reportAbuseHandlerForUrl:(id)arg1;
- (void)dealloc;
