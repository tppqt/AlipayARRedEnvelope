...
- (void)queryHomePageScanResultWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)queryHomePageScanInfoWithRequestWithCompletion:(CDUnknownBlockType)arg1;
- (void)queryAilableEnvelopeavWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
