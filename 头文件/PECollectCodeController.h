...
@class NSString, PECollectTotalHeadView, PEQRCodeHelper, TTTAttributedLabel, UIButton, UIImageView, UILabel, UITapGestureRecognizer, UIView;
...
- (void)saveCollectCodeViewToImageGallery;
- (void)configShowAudioImage:(_Bool)arg1 audioState:(_Bool)arg2;
- (id)codeHelper;
