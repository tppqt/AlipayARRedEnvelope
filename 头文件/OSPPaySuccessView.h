...
@class APSKLaunchpad, NSArray, NSDictionary, NSString, OPTimeOffsetHelper, OSPArrowButton, OSPGoodsInfoView, OSPMutableLinePanel, OSPPayChannel, OSPPayResultView, OSPRowPannel, UIButton, UIImageView, UILabel, UIScrollView, UIViewController;
