...
@class ALPFundServiceAPI, ALPFundTransferInBottomView, ALPFundTransferInLimitView, APInputBoxCell, APWealthBankCell, DTRpcAsyncCaller, NSDictionary, NSString, UILabel, WEALTHMobileChannelManager, WEALTHRecommendChannelInfo;

@interface ALPFundTransferInViewController : BEEFunctionTableController <UITableViewDataSource, UITextFieldDelegate, UIAlertViewDelegate, UITableViewDelegate>
{
    _Bool _queryAdvInfo;
