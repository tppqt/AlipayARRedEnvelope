...
@interface KBShopInfoResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    NSMutableArray *_kbShopInfoList;
}

+ (id)parseFromData:(id)arg1;
@property(retain, nonatomic) NSMutableArray *kbShopInfoList; // @synthesize kbShopInfoList=_kbShopInfoList;
...
- (void)addKbShopInfoList:(id)arg1;
- (void)setKbShopInfoListArray:(id)arg1;
- (int)serializedSize;
