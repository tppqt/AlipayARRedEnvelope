...
@class EmotionBoardView, LSCommentView, NSMutableArray, NSString, UITapGestureRecognizer;

@interface LSCommentBaseViewController : DTViewController <CTGrowingTextViewDelegate, LSCommentViewDelegate, EmotionBoardViewDelegate>
{
    _Bool _isNormalShow;
    _Bool _isViewShow;
...
@property(retain, nonatomic) LSCommentView *commentView; // @synthesize commentView=_commentView;
