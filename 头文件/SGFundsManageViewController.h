...
@interface SGFundsManageViewController : SGFundsBaseViewController <UITableViewDataSource, UITableViewDelegate, SGFMBaseCellDelegate, UIActionSheetDelegate, SafePayDelegate, PKStatusBarDelegate, SGFMListPanelDelegate>
{
