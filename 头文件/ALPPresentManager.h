...
- (void)doPresentWithPassId:(id)arg1 title:(id)arg2 desc:(id)arg3 tips:(id)arg4 imgString:(id)arg5 needInput:(_Bool)arg6 success:(CDUnknownBlockType)arg7 failure:(CDUnknownBlockType)arg8;
