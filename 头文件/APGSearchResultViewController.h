...
@class APGSearchResultContentViewController, APGSegmentItemsContentView, MOBILESEARCHMenuGroup, NSArray, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIScrollView;
...
{
    NSArray *_tabItems;
    MOBILESEARCHMenuGroup *_menuGroup;
...
@property(retain, nonatomic) MOBILESEARCHMenuGroup *menuGroup; // @synthesize menuGroup=_menuGroup;
