...
@interface APRichTextLabel : UIView
{
    _Bool _highlighted;
    int _textAlignment;
    int _lineBreakMode;
    ...
    id <APRichTextLabelDelegate> _delegate;
...
@property(nonatomic) __weak id <APRichTextLabelDelegate> delegate; // @synthesize delegate=_delegate;
