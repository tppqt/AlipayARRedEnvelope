...
@class APActionSheet, APToastView, BEEAssetManager, BEEAssetPickedManager, BEEDirectPreviewPicker, BEEPhotoBrowser, DTNavigationController, NSArray, NSString, UIViewController;

@interface BEEPhotoPicker : NSObject <UIActionSheetDelegate, UIImagePickerControllerDelegate, BEENaviControllerDelegate, UINavigationControllerDelegate, BEEQuickPickViewDelegate, UIAlertViewDelegate, BEEDirectPreviewPickerDelegate, BEEGridPickControllerDelegate>
{
...
@property(retain, nonatomic) APActionSheet *apActionSheet; // @synthesize apActionSheet=_apActionSheet;
