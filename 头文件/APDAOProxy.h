...
- (id)__executeUpdateMethod:(id)arg1 onTable:(id)arg2 withArguments:(id)arg3 andInsertionCallback:(CDUnknownBlockType)arg4 status:(long long *)arg5 profile:(CDStruct_06d3d77b *)arg6;
- (id)__executeSelectMethod:(id)arg1 onTable:(id)arg2 withArguments:(id)arg3 status:(long long *)arg4 profile:(CDStruct_06d3d77b *)arg5;
