...
@interface RecoverVcardsResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasResultDesc;
    _Bool _hasIsLastPage;
    _Bool _success;
    _Bool _isLastPage;
    int _resultCode;
...
@property(readonly) _Bool hasIsLastPage; // @synthesize hasIsLastPage=_hasIsLastPage;
