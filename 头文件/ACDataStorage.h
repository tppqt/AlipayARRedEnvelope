...
- (id)initInPrivate;
- (id)init;
- (void)moveInstalledAppBaseInfoOf930Data;
- (void)moveAppBaseInfoOf930Data;
- (id)childStageCodesForStageNames:(id)arg1;
- (void)updateSystemSearchIndex;
- (void)updateGlobalSearchIndex:(id)arg1;
- (id)globalSearchService;
- (_Bool)needUpdateSearchIndexForStage:(id)arg1;
...
- (void)getGlocalSearchIndexConfig:(id)arg1;
