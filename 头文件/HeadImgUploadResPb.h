...
@interface HeadImgUploadResPb : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasMessage;
    _Bool _hasUserHeadImgPath;
    _Bool _success;
...
@property(retain, nonatomic) NSString *userHeadImgPath; // @synthesize userHeadImgPath=_userHeadImgPath;
@property(retain, nonatomic) NSString *message; // @synthesize message=_message;
@property(retain, nonatomic) NSString *resultCode; // @synthesize resultCode=_resultCode;
@property(nonatomic) _Bool success; // @synthesize success=_success;
@property(readonly) _Bool hasUserHeadImgPath; // @synthesize hasUserHeadImgPath=_hasUserHeadImgPath;
