...
#import "VideoRecorderWriterDelegate.h"

@class APBeautyManager, APMRecorderFocusView, APMTextureView, APMVideoPreviewViewContainer, APVideoRemoteInfo, AVCaptureAudioDataOutput, AVCaptureConnection, AVCaptureDeviceInput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, CLLocation, CLLocationManager, CMMotionManager, EAGLContext, NSDate, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSTimer, RecorderLightDarkView, RecorderLoadingView, UIImage, UILabel, VideoRecorderWriter;

@interface APVideoRecorder : UIView <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, VideoRecorderWriterDelegate, APAudioSessionManagerDelegate, RecorderLightDarkViewDelegate, APBeautyManagerDelegate, CLLocationManagerDelegate>
{
    _Bool _allowedToUseGPU;
    _Bool _enableBeautyMode;
    _Bool _willCompressWhenInterrupted;
    _Bool _willStoreIntoHistory;
    _Bool _needsPostProcessing;
    ...
    VideoRecorderWriter *_videoDataRecorder;
...
@property(retain, nonatomic) NSDate *imageSampleReadyTime; // @synthesize imageSampleReadyTime=_imageSampleReadyTime;
...
@property(retain, nonatomic) VideoRecorderWriter *videoDataRecorder; // @synthesize videoDataRecorder=_videoDataRecorder;
...
@property(nonatomic) _Bool willStoreIntoHistory; // @synthesize willStoreIntoHistory=_willStoreIntoHistory;
...
- (void).cxx_destruct;
- (void)setCanShowLowLightReminder:(_Bool)arg1;
- (void)layoutSubviews;
- (_Bool)isDark;
...
- (void)videoRecorderDidFinishRecording:(id)arg1;
- (void)videoRecorder:(id)arg1 didFailWithError:(id)arg2;
