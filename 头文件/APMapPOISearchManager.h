...
@class AMapSearchAPI, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSString;

@interface APMapPOISearchManager : NSObject <AMapSearchDelegate>
{
