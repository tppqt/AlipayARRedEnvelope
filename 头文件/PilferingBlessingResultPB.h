...
@interface PilferingBlessingResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) BlessingCardVoPB *blessing; // @dynamic blessing;
@property(retain, nonatomic) NSString *code; // @dynamic code;
@property(retain, nonatomic) NSString *followAction; // @dynamic followAction;
@property(readonly) _Bool hasBlessing; // @dynamic hasBlessing;
@property(readonly) _Bool hasCode; // @dynamic hasCode;
@property(readonly) _Bool hasFollowAction; // @dynamic hasFollowAction;
@property(readonly) _Bool hasMockMsg; // @dynamic hasMockMsg;
@property(readonly) _Bool hasPilfingCardId; // @dynamic hasPilfingCardId;
@property(readonly) _Bool hasResultView; // @dynamic hasResultView;
@property(readonly) _Bool hasSuccess; // @dynamic hasSuccess;
@property(retain, nonatomic) NSString *mockMsg; // @dynamic mockMsg;
@property(retain, nonatomic) NSString *pilfingCardId; // @dynamic pilfingCardId;
