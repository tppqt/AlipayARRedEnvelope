...
@interface CreateShareCodeResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasResultDesc;
    _Bool _hasShareCode;
    _Bool _hasPreContent;
    _Bool _hasEndContent;
    _Bool _hasTitle;
    _Bool _success;
    int _resultCode;
...
@property(readonly) _Bool hasEndContent; // @synthesize hasEndContent=_hasEndContent;
@property(readonly) _Bool hasPreContent; // @synthesize hasPreContent=_hasPreContent;
@property(readonly) _Bool hasShareCode; // @synthesize hasShareCode=_hasShareCode;
