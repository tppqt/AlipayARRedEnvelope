...
@interface MutualFriendResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    _Bool _success;
    int _resultCode;
    NSMutableArray *_matualFriendList;
...
@property(retain, nonatomic) NSMutableArray *matualFriendList; // @synthesize matualFriendList=_matualFriendList;
...
- (void)addMatualFriendList:(id)arg1;
- (void)setMatualFriendListArray:(id)arg1;
- (int)serializedSize;
