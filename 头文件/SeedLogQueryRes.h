...
@class Merchant, NSMutableArray, NSString;

@interface SeedLogQueryRes : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    NSString *_amountFee;
    NSString *_extInfo;
    NSMutableArray *_seedLogItem;
}

+ (id)parseFromData:(id)arg1;
@property(retain, nonatomic) NSMutableArray *seedLogItem; // @synthesize seedLogItem=_seedLogItem;
@property(retain, nonatomic) NSString *extInfo; // @synthesize extInfo=_extInfo;
@property(retain, nonatomic) NSString *amountFee; // @synthesize amountFee=_amountFee;
...
@property(readonly) _Bool hasAmountFee; // @synthesize hasAmountFee=_hasAmountFee;
...
- (void)addSeedLogItem:(id)arg1;
- (void)setSeedLogItemArray:(id)arg1;
- (int)serializedSize;
