...
@interface VideoSetting : NSObject <SettingUpdateProtocal>
{
    ...
    int _bitrate4Export;
    int _bitrate4Export4PostProcessing;
    int _fps;
    ...
    struct CGSize _size4Capture4PostProcessing;
    struct CGSize _size4Export4PostProcessing;
...
@property(nonatomic) int bitrate4Export4PostProcessing; // @synthesize bitrate4Export4PostProcessing=_bitrate4Export4PostProcessing;
@property(nonatomic) struct CGSize size4Export4PostProcessing; // @synthesize size4Export4PostProcessing=_size4Export4PostProcessing;
@property(nonatomic) struct CGSize size4Capture4PostProcessing; // @synthesize size4Capture4PostProcessing=_size4Capture4PostProcessing;
