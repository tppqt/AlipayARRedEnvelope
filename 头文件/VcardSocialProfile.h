...
@interface VcardSocialProfile : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasLabel;
    _Bool _hasUrlString;
    _Bool _hasUsername;
    _Bool _hasUserIdentifier;
    _Bool _hasService;
    NSString *_label;
    NSString *_urlString;
    NSString *_username;
...
@property(readonly) _Bool hasUserIdentifier; // @synthesize hasUserIdentifier=_hasUserIdentifier;
@property(readonly) _Bool hasUsername; // @synthesize hasUsername=_hasUsername;
@property(readonly) _Bool hasUrlString; // @synthesize hasUrlString=_hasUrlString;
