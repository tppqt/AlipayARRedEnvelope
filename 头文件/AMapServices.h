...
@class AMapPatchManager, NSString;
...
@interface AMapServices : NSObject
{
    ...
    AMapPatchManager *_patchManager;
}
...
@property(retain, nonatomic) AMapPatchManager *patchManager; // @synthesize patchManager=_patchManager;
