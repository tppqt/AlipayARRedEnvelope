...
@class NSArray, NSDictionary, NSString, O2OSearchDisplayListModel, O2OSearchMiddleDisplayVCModel, O2OSearchMiddleLogic, UITableView;
...
- (void)promotionDatasDidFinishLoading:(id)arg1 spaceCodes:(id)arg2 extInfo:(id)arg3;
- (void)setLastQuery:(id)arg1;
- (void)didSelectedQuery:(id)arg1 fromSearchSrc:(id)arg2 src:(unsigned long long)arg3;
- (void)didSelectedRecordItem:(id)arg1 fromSearchSrc:(id)arg2 src:(unsigned long long)arg3;
