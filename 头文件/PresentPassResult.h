...
@interface PresentPassResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasResultDesc;
    _Bool _hasResultView;
    _Bool _hasPresentOutId;
    _Bool _hasPassId;
...
@property(retain, nonatomic) NSString *presentOutId; // @synthesize presentOutId=_presentOutId;
...
@property(readonly) _Bool hasPresentOutId; // @synthesize hasPresentOutId=_hasPresentOutId;
