...
@class APNextPagePullView, MASConstraint, MVCinemaRow, MVCinemaSection, MVFilmBannerRow, MVFilterView, MVGetCinemaListResponse, MVLocationBar, MVPresentView, MVRegionFilterNoticeView, MVSegmentControl, MVShowModel, MVTableSection, MVTableViewDataSource, NSArray, NSMutableArray, NSString, TBSDKMTOPServer, UIViewController;
...
@interface MVCinemaListViewController : MVTableViewController <UIGestureRecognizerDelegate>
{
    ...
    MVFilterView *_defaultFilterView;
    ...
    MVRegionFilterNoticeView *_regionFilterNoticeView;
...
@property(retain, nonatomic) MVRegionFilterNoticeView *regionFilterNoticeView; // @synthesize regionFilterNoticeView=_regionFilterNoticeView;
...
@property(retain, nonatomic) MVFilterView *defaultFilterView; // @synthesize defaultFilterView=_defaultFilterView;
...
- (void)switchFilterIcon:(_Bool)arg1;
- (void)goFiltering:(id)arg1;
