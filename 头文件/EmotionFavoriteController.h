...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIImage, UIView;

@interface EmotionFavoriteController : BEEScrollController <BEEPhotoPickerDelegate>
{
    UIView *_editingBar;
