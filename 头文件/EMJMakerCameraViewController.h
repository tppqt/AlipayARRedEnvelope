...
@interface EMJMakerCameraViewController : DTBaseViewController <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UICollectionViewDelegate, UIAlertViewDelegate, UICollectionViewDataSource>
{
