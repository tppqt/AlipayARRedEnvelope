...
@class APBarButtonItem, NSString, WEALTHFundAutoTransferOutApplyResult;
...
@interface AutoTransferOutListViewController : AutoTransferBaseTableViewController <UITableViewDataSource, UITableViewDelegate, AutoTransferRuleCellButtonClickDelegate>
{
    _Bool _ruleEditing;
    _Bool _needReload;
    APBarButtonItem *_editBarItem;
    APBarButtonItem *_finishBarItem;
...
@property(retain, nonatomic) APBarButtonItem *finishBarItem; // @synthesize finishBarItem=_finishBarItem;
@property(retain, nonatomic) APBarButtonItem *editBarItem; // @synthesize editBarItem=_editBarItem;
- (void).cxx_destruct;
