...
@class NSError, NSLock, NSObject<OS_dispatch_queue>, NSString;

@interface DjangoDownloadRequestOperation : AFHTTPRequestOperation
{
    NSError *_fileError;
    id _responseObject;
...
@property(retain, nonatomic) NSString *djangoId; // @synthesize djangoId=_djangoId;
- (void).cxx_destruct;
- (id)cacheFolder;
