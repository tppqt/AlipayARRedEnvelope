...
@class LSLiveShowInfo, NSTimer, UIButton, UIImageView, UILabel;

@interface LSReplayCardView : UIView
{
...
@property(copy, nonatomic) LSLiveShowInfo *liveshowInfo; // @synthesize liveshowInfo=_liveshowInfo;
