...
@optional
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 didClickBonusAtIndex:(long long)arg2;
- (NSString *)bonusImageCloudIdInPhotoBrowser:(BEEPhotoBrowser *)arg1 atIndex:(long long)arg2;
