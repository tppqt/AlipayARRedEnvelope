...
@class AMapSearchAPI, APExceptionView, BEECity, EGORefreshTableHeaderView, EWCardListView, EWListMenu, EWMapView, EWPolyPointView, MOPEnterDaowayMainViewReq, NSArray, NSMutableArray, NSString, NSTimer, UIButton, UILabel, UITableView, UIView;

@interface EWMainViewController : EWBaseViewController <CLLocationManagerDelegate, UITextFieldDelegate, APMapKitViewDelegate, EWCardListViewDelegate, UITableViewDataSource, UITableViewDelegate, EGORefreshTableHeaderDelegate, UIAlertViewDelegate, AMapSearchDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate>
{
