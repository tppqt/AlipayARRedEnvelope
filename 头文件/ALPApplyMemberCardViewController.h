...
@class ALPCreateMemberModel, ALPMemberCardListViewDataSource, ALPMemberCardListViewDelegate, ALPMemberCardPreviewModel, ALPNavigationBar, ALPQueryMemberInfoModel, AMCH5ServiceController, APActionSheet, APExceptionView, KABAOPRODMemberCardRequest, NSString;
...
- (void)viewDidLoad;
- (id)initWithCardInfo:(id)arg1 onlyPreview:(_Bool)arg2;
