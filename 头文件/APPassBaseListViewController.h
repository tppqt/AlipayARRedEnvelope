...
@class APActionSheet, APExceptionView, APTableView, NSMutableArray, NSString, ODRefreshControl;

@interface APPassBaseListViewController : APPassBaseBizViewController <UIActionSheetDelegate, UITableViewDataSource, UITableViewDelegate, SVTableViewCellDelegate>
{
