...
- (void)setTestService:(id)arg1;
- (id)testService;
@property(retain, nonatomic) NSString *switchSpmMonitor;
@property(retain, nonatomic) NSString *switchPagetsRpcHeader;
@property(retain, nonatomic) NSMutableDictionary *shemeChInfoDic;
- (id)appendABTest:(id)arg1 seedId:(id)arg2;
