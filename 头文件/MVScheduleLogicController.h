...
- (void).cxx_destruct;
- (void)startSeatPickWithSchedule:(id)arg1 showName:(id)arg2 showId:(id)arg3 cinemaName:(id)arg4 cinemaModel:(id)arg5;
- (void)gotoNormalSeatPick:(id)arg1 showName:(id)arg2 showId:(id)arg3 cinemaName:(id)arg4;
