...
@interface PotentialFriendOfFriendResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    _Bool _success;
    int _resultCode;
    NSMutableArray *_potentialFriends;
...
@property(retain, nonatomic) NSMutableArray *potentialFriends; // @synthesize potentialFriends=_potentialFriends;
...
- (void)addPotentialFriends:(id)arg1;
- (void)setPotentialFriendsArray:(id)arg1;
- (int)serializedSize;
