...
@class APContactInfo, APContactLocalSearchManager, APInputBox, NSString, TFMatchMobileListView, TFReciverInfoChecker, TFTransferRequest, UIActivityIndicatorView, UIButton, UITableView, UITextField;
