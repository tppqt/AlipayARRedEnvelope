...
- (void).cxx_destruct;
- (_Bool)marketingToolsChangeCheck:(id)arg1 mcardStatus:(id)arg2 selectedSeatsNumber:(long long)arg3 completion:(CDUnknownBlockType)arg4;
- (_Bool)lockedSeatAfterCheck:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)lockedSeatCheck:(id)arg1 scheduleId:(id)arg2 completion:(CDUnknownBlockType)arg3;
