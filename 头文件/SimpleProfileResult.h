...
@class NSString, SimpleProfileRecord;

@interface SimpleProfileResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    SimpleProfileRecord *_record;
}

+ (id)parseFromData:(id)arg1;
@property(retain, nonatomic) SimpleProfileRecord *record; // @synthesize record=_record;
