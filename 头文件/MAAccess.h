...
- (void)setAbTag:(id)arg1;
- (void)setComposeSwitch:(_Bool)arg1;
- (void)setShortChannelTimeoutConfig:(unsigned long long)arg1;
- (void)noticeStatusTimerSwitch:(_Bool)arg1;
- (void)noticeRPCRetrySwitch:(_Bool)arg1;
- (void)noticeShortFrequencySwitch:(_Bool)arg1;
- (void)noticeHttpShortChannelSwitch:(_Bool)arg1;
