...
@interface PassShareResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
...
@property(readonly) _Bool hasShareUrl; // @synthesize hasShareUrl=_hasShareUrl;
@property(readonly) _Bool hasPassId; // @synthesize hasPassId=_hasPassId;
@property(readonly) _Bool hasShareContext; // @synthesize hasShareContext=_hasShareContext;
