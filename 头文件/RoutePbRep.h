...
@interface RoutePbRep : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasMemo;
    _Bool _hasRouteInfos;
    _Bool _success;
    int _resultCode;
    NSString *_memo;
...
@property(readonly) _Bool hasRouteInfos; // @synthesize hasRouteInfos=_hasRouteInfos;
