...
- (void)dealloc;
- (void)initInternalWithVideoSize:(struct CGSize)arg1 frameRate:(int)arg2 bitrate:(int)arg3 useInterfaceOrientation:(_Bool)arg4 cameraState:(long long)arg5 aspectMode:(long long)arg6 maxSendBufferSize:(unsigned long long)arg7 maxCongestionResumeEventCout:(unsigned long long)arg8;
- (id)initWithVideoSize:(struct CGSize)arg1 frameRate:(int)arg2 bitrate:(int)arg3 useInterfaceOrientation:(_Bool)arg4 cameraState:(long long)arg5 maxSendBufferSize:(unsigned long long)arg6 maxCongestionResumeEventCout:(unsigned long long)arg7;
