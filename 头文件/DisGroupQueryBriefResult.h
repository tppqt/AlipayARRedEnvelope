...
@interface DisGroupQueryBriefResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasGroup;
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasResultDesc;
    _Bool _hasChatMessage;
    _Bool _success;
    int _resultCode;
    GroupVO *_group;
...
@property(retain, nonatomic) GroupVO *group; // @synthesize group=_group;
@property(readonly) _Bool hasChatMessage; // @synthesize hasChatMessage=_hasChatMessage;
...
@property(readonly) _Bool hasGroup; // @synthesize hasGroup=_hasGroup;
- (void).cxx_destruct;
