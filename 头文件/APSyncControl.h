...
- (void)sendSyncMessage7002BizSyncInfo:(id)arg1 forwardIP:(unsigned int)arg2 header:(id)arg3;
...
- (long long)processUserData:(id)arg1 keyDicId:(id)arg2 sKeyDic:(id)arg3 bizSyncInfo:(id)arg4 bucketBizInfo:(id)arg5 header:(id)arg6;
- (long long)processDeviceData:(id)arg1 sKeyDic:(id)arg2 bizSyncInfo:(id)arg3 bucketBizInfo:(id)arg4 header:(id)arg5;
