...
@class APLocationCheckIn, NSString;

@interface XTBusinessCommonServiceImpl : NSObject <XTBusinessCommonService>
{
    _Bool _recvDeviceToken;
    _Bool _isShowLaunchTips;
    APLocationCheckIn *_locationChecker;
    NSString *_userId;
}

@property(nonatomic) _Bool isShowLaunchTips; // @synthesize isShowLaunchTips=_isShowLaunchTips;
@property(nonatomic) _Bool recvDeviceToken; // @synthesize recvDeviceToken=_recvDeviceToken;
@property(retain, nonatomic) NSString *userId; // @synthesize userId=_userId;
@property(retain, nonatomic) APLocationCheckIn *locationChecker; // @synthesize locationChecker=_locationChecker;
- (void).cxx_destruct;
