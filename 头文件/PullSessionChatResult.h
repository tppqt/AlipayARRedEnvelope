...
@interface PullSessionChatResult : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    ...
    NSMutableArray *_chatMessage;
}

+ (id)parseFromData:(id)arg1;
@property(retain, nonatomic) NSMutableArray *chatMessage; // @synthesize chatMessage=_chatMessage;
...
- (void)setChatMessageArray:(id)arg1;
- (int)serializedSize;
