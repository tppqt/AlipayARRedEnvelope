...
@property(readonly, copy, nonatomic) NSString *certpay; // @synthesize certpay=_certpay;
...
- (id)hascertpay;
@property(readonly, copy, nonatomic) NSString *hasalipay; // @synthesize hasalipay=_hasalipay;
