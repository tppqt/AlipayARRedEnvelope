...
@class APActivityIndicatorView, NSLayoutConstraint;

@interface O2ODTTitleView : UILabel
{
    _Bool w_isUsed;
    NSLayoutConstraint *_leftContstraint;
    APActivityIndicatorView *_titleLoading;
}

@property(retain, nonatomic) APActivityIndicatorView *titleLoading; // @synthesize titleLoading=_titleLoading;
