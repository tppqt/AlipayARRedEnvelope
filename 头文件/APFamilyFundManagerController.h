...
@interface APFamilyFundManagerController : BEEFunctionTableController <APFamilyFundTerminateResultControllerDelegate, ALPTransferBtnClicked, ALPCellDidClick, BEEMaskViewDelegate, APFundFamilyUnbindAuthViewDelegate, UIAlertViewDelegate>
{
    _Bool _needRefresh;
