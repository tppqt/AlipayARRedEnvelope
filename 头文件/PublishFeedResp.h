...
@interface PublishFeedResp : APPBGeneratedMessage <GeneratedMessageProtocol>
{
...
@property(retain, nonatomic) Feed *mockFeed; // @synthesize mockFeed=_mockFeed;
...
@property(readonly) _Bool hasMockFeed; // @synthesize hasMockFeed=_hasMockFeed;
