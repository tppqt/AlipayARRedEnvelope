...
- (id)registerVerifyEmailAndVerificationV2:(id)arg1 callBack:(CDUnknownBlockType)arg2;
...
- (id)mobileRegPreVerifyV3:(id)arg1 extraInfo:(id)arg2 callBack:(CDUnknownBlockType)arg3;
