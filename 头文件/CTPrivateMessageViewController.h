...
#import "APSocialTipsViewDelegate.h"
...
@class ABUnknownPersonViewController, APBarButtonItem, APChatLocalSearchManager, APChatRoomSetTagViewController, APChatRoomSimpleProfileController, APContactInfo, APSnapChapGuildView, APSocialNoticeDisplayView, APSocialTipsModel, APSocialTipsView, CTCoverAlertView, CTLoadingHeadView, CTTitleView, DTRpcAsyncCaller, MFMailComposeViewController, NSArray, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString, NSTimer, PKChatSnapVideoShowView, PKSnapChatImageView, PKSnapChatVideoWidget, PKStatusBar, PKVoiceToWordView, UIActivityIndicatorView, UIButton, UITextField, UIView, UIWebView, UIWindow;

@interface CTPrivateMessageViewController : CTAutoVoicePlayViewController <UIScrollViewDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, UIAlertViewDelegate, MFMailComposeViewControllerDelegate, CTMessageCellUserNameDelegate, CTMessageCellEditModeDelegate, CTActionToolViewDelegate, PKStatusBarDelegate, APSearchBarDelegate, CTMessageDetailViewDelegate, CTMessageCellDelegate, ABPeoplePickerNavigationControllerDelegate, ABNewPersonViewControllerDelegate, APSnapChapGuildViewDelegate, PKChatSnapVideoShowViewDelegate, PKSnapChatVideoWidgetDelegate, CNContactViewControllerDelegate, CNContactPickerDelegate, BEEPhotoBrowserDelegate, WWPhotoBrowserDelegate, APSocialTipsViewDelegate>
{
    _Bool _isScorlling;
    ...
    _Bool _didLoadSocialTip;
    _Bool _didStoreContentInset;
    ...
    APSocialTipsView *_socialTipsView;
    APSocialTipsModel *_socialTipsModel;
...
@property(nonatomic) _Bool didStoreContentInset; // @synthesize didStoreContentInset=_didStoreContentInset;
@property(nonatomic) _Bool didLoadSocialTip; // @synthesize didLoadSocialTip=_didLoadSocialTip;
@property(retain, nonatomic) APSocialTipsModel *socialTipsModel; // @synthesize socialTipsModel=_socialTipsModel;
@property(retain, nonatomic) APSocialTipsView *socialTipsView; // @synthesize socialTipsView=_socialTipsView;
...
- (void)clearSocialTip;
- (void)createTipModel:(id)arg1;
- (void)changePrivateMessageTip:(id)arg1;
- (void)tipViewDisappear:(id)arg1 finished:(id)arg2 context:(void *)arg3;
- (void)dismissTipsViewAnimated:(_Bool)arg1;
- (void)showTipsViewAnimated:(_Bool)arg1;
- (void)refreshTipView;
- (void)loadLocalSocialTipWithParameters:(id)arg1;
- (void)socialTipsIconClickRespond:(id)arg1;
- (void)socialTipsShowRespond:(id)arg1;
- (void)socialTipsIgnoreRespond:(id)arg1;
- (_Bool)hasUnreadMsgs;
...
- (void)doPrivateResumeWithOptions:(id)arg1 isResume:(_Bool)arg2;
