...
- (void).cxx_destruct;
- (void)appDelegateWithClassName:(id)arg1 options:(id)arg2;
- (void)pushOrSetRootViewController:(id)arg1;
- (id)QuotationMake:(id)arg1 symbol:(id)arg2;
- (void)pushStockDeatil:(id)arg1 source:(id)arg2;
- (void)routeController:(id)arg1;
