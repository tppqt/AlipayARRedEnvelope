...
@interface BarcodeViewController : OSPBaseViewController <UIScrollViewDelegate, UIActionSheetDelegate, UIAlertViewDelegate, OSPTipsCloseProtocol>
{
...
- (void)modifyRefreshButton:(_Bool)arg1;
