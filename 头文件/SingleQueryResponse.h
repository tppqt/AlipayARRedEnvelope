...
@class ArModelInfo, NSString;

@interface SingleQueryResponse : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasResultDesc;
    _Bool _hasResultView;
    _Bool _hasArModelInfos;
...
@property(retain, nonatomic) ArModelInfo *arModelInfos; // @synthesize arModelInfos=_arModelInfos;
...
@property(readonly) _Bool hasArModelInfos; // @synthesize hasArModelInfos=_hasArModelInfos;
