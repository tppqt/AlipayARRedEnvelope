...
@class APButton, APCircleProgressingIndicator, APStorageSpaceView, APToastView, BEEPieRenderView, NSMutableArray, NSString, UIColor, UILabel, UIView;
