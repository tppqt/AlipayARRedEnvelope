...
@class ALPDatePicker, APAgreementBox, APButton, APInputBox, APSmsSecurityCodeBox, CCRCertTypeModel, CCRGetCreditCardBillQueryFormRespVO, CCRSavedCard, CCRSectionObject, NSMutableArray, NSString, UIView;
...
@interface CCRActivateBankBillViewController : CCRTableBaseViewController <UIAlertViewDelegate, ALPDatePickerDelegate, APSecurityCodeBoxDelegate, UIScrollViewDelegate>
{
    ...
    APInputBox *_autoPhoneNumLabel;
    NSString *_autoPhoneNum;
    APInputBox *_identifyNumInputBox;
    APInputBox *_phoneNumInputBox;
    APInputBox *_cvv2InputBox;
...
@property(retain, nonatomic) APInputBox *cvv2InputBox; // @synthesize cvv2InputBox=_cvv2InputBox;
@property(retain, nonatomic) APInputBox *phoneNumInputBox; // @synthesize phoneNumInputBox=_phoneNumInputBox;
@property(retain, nonatomic) APInputBox *identifyNumInputBox; // @synthesize identifyNumInputBox=_identifyNumInputBox;
...
@property(retain, nonatomic) APInputBox *autoPhoneNumLabel; // @synthesize autoPhoneNumLabel=_autoPhoneNumLabel;
