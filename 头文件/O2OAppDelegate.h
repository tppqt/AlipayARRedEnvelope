...
@class NSString, O2OUnfoundClassClub, UIViewController;

@interface O2OAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    O2OUnfoundClassClub *_c;
}

@property(retain, nonatomic) O2OUnfoundClassClub *c; // @synthesize c=_c;
