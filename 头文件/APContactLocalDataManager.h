...
@class APCustomStorage, NSArray, NSDate, NSLock, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString;

@interface APContactLocalDataManager : NSObject
{
    id <APContactRelationProxy> _contactRelationProxy;
