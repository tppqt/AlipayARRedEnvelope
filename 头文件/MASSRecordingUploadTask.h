...
@class ConnectTimer, DataResponseTimer, NSData, NSMutableData, NSString;
...
@interface MASSRecordingUploadTask : MASSStreamUnit
{
    ...
    NSString *_bizType;
    NSData *_firstTmpData;
}

+ (id)initWithTaskId:(id)arg1 fileName:(id)arg2 firstData:(id)arg3 fromModel:(id)arg4 needCrypto:(_Bool)arg5;
@property(retain, nonatomic) NSData *firstTmpData; // @synthesize firstTmpData=_firstTmpData;
...
- (void)fillHttpRequestStop;
- (long long)fillHttpRequestStart;
- (void)makeToSendDataAppend:(id)arg1;
- (id)init;
- (void)dealloc;
