...
@interface TZBHandicapResponse : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *buyList; // @dynamic buyList;
...
@property(retain, nonatomic) NSArray *sellList; // @dynamic sellList;
