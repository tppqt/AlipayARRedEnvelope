...
@interface AvailableQueryResponse : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
    _Bool _hasResultCode;
    _Bool _hasResultDesc;
    _Bool _hasResultView;
    _Bool _hasAvailableCount;
    _Bool _success;
    int _availableCount;
...
@property(readonly) _Bool hasAvailableCount; // @synthesize hasAvailableCount=_hasAvailableCount;
