...
@class AMMAudioPlayer, AMMAudioRecord, APMTaskScheduler, DjangoUploadInputStream, HttpDjangoClient, NSDate, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSTimer, NetworkSetting, VoiceCache2, VoiceTask;
...
@interface APVoiceManager : NSObject <AMMAudioRecordDelegate>
{
    ...
    HttpDjangoClient *_djangoClient;
    NSString *_business;
    ...
    DjangoUploadInputStream *_audioInputStream;
...
@property(retain, nonatomic) DjangoUploadInputStream *audioInputStream; // @synthesize audioInputStream=_audioInputStream;
...
@property(retain, nonatomic) HttpDjangoClient *djangoClient; // @synthesize djangoClient=_djangoClient;
...
- (_Bool)isMassProxyEnabled4UploadWhenRecording;
...
- (id)downLoadAudioInternalWithCloudId:(id)arg1 business:(id)arg2 useHttps:(_Bool)arg3 md5:(id)arg4 priority:(unsigned long long)arg5 downLoadHandler:(CDUnknownBlockType)arg6;
...
- (void)realStop;
- (void)stopRecord;
- (void)uploadAudioStream:(id)arg1;
- (void)uploadVoiceByFileUseAFNetworking:(id)arg1 taskRecord:(id)arg2 localID:(id)arg3 business:(id)arg4;
