...
+ (void)addKeyLogWhenDownloadCompletedWithImageRequest:(id)arg1 Image:(id)arg2 ErrorString:(id)arg3;
+ (void)uploadKeyLogWhenCheckLocalImageRequestInvalid;
+ (void)uploadKeyLogWhenDownloadCompletedIfNeeded:(id)arg1 ResourceRequest:(id)arg2;
+ (void)uploadKeyLogWhenDownloadRequestInvalidWithError:(id)arg1 ImageRequest:(id)arg2;
