...
@class APDynamicDeploymentBandageInteraction, APDynamicDeploymentBirdNestInteraction, APKoubeiResourceInteraction, NSString, UIViewController;

@interface DynamicVerifyAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    APDynamicDeploymentBandageInteraction *_hotpatchInteraction;
...
@property(retain, nonatomic) APDynamicDeploymentBandageInteraction *hotpatchInteraction; // @synthesize hotpatchInteraction=_hotpatchInteraction;
