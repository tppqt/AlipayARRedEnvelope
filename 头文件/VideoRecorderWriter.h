...
@interface VideoRecorderWriter : NSObject
{
    ...
    id <VideoRecorderWriterDelegate> _delegate;
...
@property(nonatomic) __weak id <VideoRecorderWriterDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *callbackQueue; // @synthesize callbackQueue=_callbackQueue;
- (void).cxx_destruct;
@property _Bool renderingEnabled;
- (void)delegateForDidFailWithError:(id)arg1;
- (void)delegateForDidFinishRecording;
- (_Bool)isFrameSkip;
- (void)checkAndCaptureThumbnail;
- (void)updateTextureVertex;
